...
### Load raw data ---------------------------------------------------------------------------------
sakura_length <- pdf_length("./sakura-flowering/raw/sakura-modern.pdf")

sakura_raw <- pdf_text("./sakura-flowering/raw/sakura-modern.pdf")


### Format and clean tables -----------------------------------------------------------------------
#### Separate raw text into proper rows
sakura_sep_rows <- tibble(page = 1:sakura_length,
                          raw_text = sakura_raw) %>%
...
sakura_sep_cols <- sakura_sep_rows %>%
...
sakura_field_names <- sakura_sep_cols %>%
...
sakura_clean <- sakura_field_names %>%
