...
| [`sakura-flowering`](./sakura-flowering)                   | Flowering dates of the sakura (cherry blossom) tree in Kyoto, from 812-2015. Also included observed and reconstructed mean March temperatures, which are strongly linked to the flowering date. | :heavy_check_mark: |
